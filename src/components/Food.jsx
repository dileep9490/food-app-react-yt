			...
			<div className="flex flex-col lg:flex-row justify-between">
				...
				<div>
					...
					<div className="flex justify-between flex-wrap">
						...
						<button onClick={()=>filterType('burger')} className="border-orange-600 text-orange-600 hover:text-white hover:bg-orange-600 m-1">
							Burgers
						</button>
						<button onClick={()=>filterType('pizza')} className="border-orange-600 text-orange-600 hover:text-white hover:bg-orange-600 m-1">
							Pizzas
						</button>
						<button onClick={()=>filterType('salad')} className="border-orange-600 text-orange-600 hover:text-white hover:bg-orange-600 m-1">
							Salads
						</button>
						<button onClick={()=>filterType('chicken')} className="border-orange-600 text-orange-600 hover:text-white hover:bg-orange-600 m-1">
							Chicken
						</button>
					</div>
				</div>
